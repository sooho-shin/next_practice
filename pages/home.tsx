...
function HomePage (){
  ...
  // const [blackholeMaigin,setblackholeMaigin] = useState<number>(0);
  ...
  return (
    <Layout>
      ...
      <RightWrapperComponent>
        <TopRightInfo>
          <div className="left">
            <span>We do little<br/>to none:</span>
            <span>Editorial<br/>Print<br/>Graphicdesign<br/>Branding<br/>illustration</span>
          </div>
          <div className="right">
            <span>Blumenkopf is no<br/>studio. with everything <span className="sec-font">you need</span></span>
          </div>
        </TopRightInfo>
        <MainBgContainer/>
        <BlackholePositioner>
          <div className="js-blackhole-pinner blackhole-pinner">
            <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 1440 1440.003"  className="blackhole"  preserveAspectRatio="none meet">
              <path id="blackhole" d="M653,480l-720,0V-238.46C-66.172,157.7,256.818,480,653,480h0Zm720,0H653c396.025,0,719.015-322.189,720-718.216ZM-67-241.542h0V-960H651.46C256.125-959.174-66.174-636.876-67-241.542Zm1440-.241h0c-.981-395.2-323.279-717.392-718.456-718.216H1373Z" transform="translate(67 960.001)" data-v-3a229bb7="">
              </path>
            </svg>
          </div>
        </BlackholePositioner>
      ...
      <Section className="tablet">
        <CenterTextMobile>
          <div className="info-left">
            <p>We do little to none:<br/></p>
            <p>Editorial<br/> Print<br/> Graphicdesign<br/> Branding<br/> Illustration</p>
          </div>
          <div className="info-right">
            <p>Blumenkopf<br/>is no studio.<br/>with<br/>Everything<br/><span className="sec-font">you need.</span></p>
          </div>
        </CenterTextMobile>
      </Section>
      <Section className="tablet">
        <InfoBoxMobile>
          <div className="info-left">
            <p>Contact details on the home page are a good idea, we were told:</p>
          </div>
          <div className="info-right">
            <p>
              Blumenkopf kein Studio<br/>
          ...
          <AboutRight>
            ...
            <div className="right">
              <div className="top-text">
                <p>Where beauty goes the eyes might follow. 
              ...
              <p>Quite strange is the appearance,
      ...
      <Section className="no-border fd-c center-text">
        <Textfit  style={{width:'100%',height: 'auto'}} max={9999} mode="single" forceSingleModeWidth={true}>SooHoZZANG</Textfit>
      ...
      <ProjectWrapper hover={hoverState}>
        ...
        <RightWrapperComponent >
          <div className="gallery" onMouseEnter={()=>setHoverState(true)} onMouseLeave={()=>setHoverState(false)}>
...
const ProjectWrapper = styled.div<{hover:boolean}>`
  ...
  .project{
     &.first{
      animation: ${productShowAniFirst} step-end 500ms alternate forwards;
     }
    &.second{
      animation: ${productShowAniSecond} step-end 500ms alternate forwards 100ms;
       }
    &.third{
      animation: ${productShowAniThird} step-end 500ms alternate forwards 200ms;
      }
  }
  `:css`
    .project{
      &.first{
        animation: ${productShowAniFirstReverse} step-end 500ms forwards 100ms;
      }
      &.second{
        animation: ${productShowAniSecondReverse} step-end 500ms forwards 200ms;
      }
      &.third{
  ...
  .gallery{
    ...
    .content{
      ...
      .project{
        ...
        &.first{
          background-image:url(${ProductBgFirst});
          background-size:cover;
          background-position:center;
        ...
        &.second{
          background-image:url(${ProductBgSecond});
          background-size:cover;
          background-position:center;
          background-repeat:no-repeat;
          transform:translate(-50%,-50%) rotate(6deg);
        ...
        &.third{
          background-image:url(${ProductBgThird});
          background-size:cover;
          background-position:center;
          background-repeat:no-repeat;
          transform:translate(-50%,-50%) rotate(-2deg);
