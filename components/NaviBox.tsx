    ...
    return (
      <NaviWrapper naviState={naviState}>
        <div className="tablet mobile-navi">
          ...
          <button className="hamburger-group" onClick={() => {setNaviState(true)}} >
            <div></div>
            <div></div>
          </button>
        </div>
        <div className="navi-group">
            <button className="navi home sec-font" type="button" onClick={()=>pushRouter('/home')}>HOME</button>
            <button className="navi" type="button" onClick={()=>pushRouter('/work')}>WORK</button>
            <button className="navi" type="button" onClick={()=>pushRouter('/about')}>ABOUT</button>
        </div>
      </NaviWrapper>
    )
}
